...
> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/ZhipengHe/nemdatatools).

Before you ask a question, it is best to search for existing [Issues](https://github.com/ZhipengHe/nemdatatools/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/ZhipengHe/nemdatatools/issues/new).
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <github@zhipenghe.me>.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/ZhipengHe/nemdatatools/issues).
...
- The `ISSUE_TEMPLATE` and `PULL_REQUEST_TEMPLATE` are adapted from [LangFlow](https://github.com/langflow-ai/langflow/).
